# Support for Output Descriptors in Cypheriumlite Core

Since Cypheriumlite Core v0.17, there is support for Output Descriptors. This is a
...
on Cypheriumlite's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Cypheriumlite Core wallets, a convenience function `combo` is
