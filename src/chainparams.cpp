...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.cypheriumlite.loshan.co.uk");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.cypheriumlitetools.com");
        vSeeds.emplace_back("seed-b.cypheriumlite.loshan.co.uk");
