...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " cypheriumlite-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  cypheriumlite-tx [options] <hex-tx> [commands]  Update hex-encoded cypheriumlite transaction\n" +
            "or:     cypheriumlite-tx [options] -create [commands]   Create hex-encoded cypheriumlite transaction\n" +
            "\n";
