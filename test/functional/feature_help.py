...
"""Verify that starting cypheriumlite with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start cypheriumlite with -h for help text")
        ...
        self.log.info("Start cypheriumlite with -version for version information")
        ...
        self.log.info("Start cypheriumlited with -fakearg to make sure it does not start")
